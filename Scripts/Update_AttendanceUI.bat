...
:gotAdmin
    ...
    cd /d "%~dp0..\AttendanceUI"
    dotnet publish -c Release -o "%~dp0..\AttendanceUI\publish" --nologo
    if %errorlevel% neq 0 (
        echo.
    ...
    robocopy "%~dp0..\AttendanceUI\publish" "C:\inetpub\AttendanceUI" /MIR /Z /XD "logs" "UserUploads"
