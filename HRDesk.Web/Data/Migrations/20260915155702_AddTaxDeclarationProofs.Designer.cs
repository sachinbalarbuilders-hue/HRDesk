...
namespace HRDesk.Web.Data.Migrations
{
    ...
    [Migration("20260915155702_AddTaxDeclarationProofs")]
    partial class AddTaxDeclarationProofs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRDesk.Web.Models.Candidate", b =>
                {
            ...
            modelBuilder.Entity("HRDesk.Web.Models.EmployeeCTC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("SalaryBasisOverride")
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)")
                        .HasColumnName("salary_basis_override");
                    ...
                    b.ToTable("employee_ctc", (string)null);
                });
            ...
            modelBuilder.Entity("HRDesk.Web.Models.EmployeeExit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ClearanceChecklistJson")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)")
                        .HasColumnName("clearance_checklist_json");

                    b.Property<string>("ClearanceDocContentType")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("clearance_doc_content_type");

                    b.Property<byte[]>("ClearanceDocData")
                        .HasColumnType("varbinary(max)")
                        .HasColumnName("clearance_doc_data");

                    b.Property<string>("ClearanceDocFileName")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)")
                        .HasColumnName("clearance_doc_filename");
                    ...
                    b.Property<bool>("ExitInterviewCompleted")
                        .HasColumnType("bit")
                        .HasColumnName("exit_interview_completed");
                    ...
                    b.Property<string>("ExperienceLetterContentType")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("experience_letter_content_type");

                    b.Property<byte[]>("ExperienceLetterData")
                        .HasColumnType("varbinary(max)")
                        .HasColumnName("experience_letter_data");

                    b.Property<string>("ExperienceLetterFileName")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)")
                        .HasColumnName("experience_letter_filename");
                    ...
                    b.Property<bool>("IsEligibleForRehire")
                        .HasColumnType("bit")
                        .HasColumnName("is_eligible_for_rehire");
                    ...
                    b.Property<DateTime?>("RelievedAt")
                        .HasColumnType("datetime2")
                        .HasColumnName("relieved_at");

                    b.Property<string>("RelievingLetterContentType")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("relieving_letter_content_type");

                    b.Property<byte[]>("RelievingLetterData")
                        .HasColumnType("varbinary(max)")
                        .HasColumnName("relieving_letter_data");

                    b.Property<string>("RelievingLetterFileName")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)")
                        .HasColumnName("relieving_letter_filename");
                    ...
                    b.Property<string>("ResignationDocContentType")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("resignation_doc_content_type");

                    b.Property<byte[]>("ResignationDocData")
                        .HasColumnType("varbinary(max)")
                        .HasColumnName("resignation_doc_data");

                    b.Property<string>("ResignationDocFileName")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)")
                        .HasColumnName("resignation_doc_filename");
            ...
            modelBuilder.Entity("HRDesk.Web.Models.InterviewSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRDesk.Web.Models.PayGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("CapEmployeePf")
                        .HasColumnType("bit")
                        .HasColumnName("cap_employee_pf");

                    b.Property<bool>("CapEmployerPf")
                        .HasColumnType("bit")
                        .HasColumnName("cap_employer_pf");
                    ...
                    b.Property<string>("LopRounding")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasColumnName("lop_rounding");
            ...
            modelBuilder.Entity("HRDesk.Web.Models.ProfessionalTaxSlab", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("OrganizationId", "State", "MinGross");
            ...
            modelBuilder.Entity("HRDesk.Web.Models.SalaryComponent", b =>
                {
                    ...
                    b.Property<bool>("IsEpfApplicable")
                        .HasColumnType("bit")
                        .HasColumnName("is_epf_applicable");
            ...
            modelBuilder.Entity("HRDesk.Web.Models.SalaryStructureTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HRDesk.Web.Models.TemplateComponent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("template_components", (string)null);
                });
            ...
            modelBuilder.Entity("HRDesk.Web.Models.Employee", b =>
                {
                    ...
                    b.HasOne("HRDesk.Web.Models.PayGroup", "PayGroup")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("HRDesk.Web.Models.EmployeeCTC", b =>
                {
                    ...
                    b.HasOne("HRDesk.Web.Models.SalaryStructureTemplate", "Template")
                        .WithMany("EmployeeCTCs")
            ...
            modelBuilder.Entity("HRDesk.Web.Models.InterviewSchedule", b =>
                {
                    b.HasOne("HRDesk.Web.Models.Candidate", "Candidate")
                        .WithMany()
            ...
            modelBuilder.Entity("HRDesk.Web.Models.TemplateComponent", b =>
                {
                    b.HasOne("HRDesk.Web.Models.SalaryComponent", "Component")
                        .WithMany()
                        .HasForeignKey("ComponentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
