...
export const PaginationToolbar: React.FC<PaginationToolbarProps> = ({
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs font-normal select-none py-1">
      ...
      <div className="flex items-center gap-1.5 self-end sm:self-auto">
        <span className="text-[var(--text-secondary)] mr-3 text-xs">
