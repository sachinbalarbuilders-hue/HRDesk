  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center p-6 text-center animate-fade-in">
      <div className="max-w-md w-full p-8 rounded-2xl bg-[var(--surface)] border border-[var(--rule)] shadow-lg flex flex-col items-center">
        ...
        {/* Badge */}
        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-normal  font-semibold bg-rose-500/10 text-rose-700 dark:text-rose-300 border border-rose-500/20 mb-3">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2.5 w-full">
          <button
            onClick={() => navigate(-1)}
            className="w-full sm:w-1/2 py-2.5 px-4 rounded-lg text-sm font-semibold border border-[var(--rule)] bg-[var(--surface)] text-[var(--text-primary)] hover:bg-[var(--paper)] transition-colors flex items-center justify-center gap-1.5 cursor-pointer shadow-2xs"
          >
            <ArrowLeft size={14} />
            <span>Go Back</span>
          </button>
          ...
          <button
            ...
            className="w-full sm:w-1/2 py-2.5 px-4 rounded-lg text-sm font-semibold bg-[var(--accent)] text-white hover:opacity-90 transition-opacity flex items-center justify-center gap-1.5 cursor-pointer shadow-2xs"
          >
