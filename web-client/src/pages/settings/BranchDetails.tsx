...
export const BranchDetails: React.FC = () => {
  ...
  if (loading) {
    return <div className="p-8 text-center text-[var(--text-secondary)] text-xs ">Loading branch details...</div>;
  }
        ...
        <div className="flex border-b border-[var(--rule)] px-4">
          <button
            className={`px-4 py-3 text-xs font-semibold cursor-pointer border-b-2 transition-colors ${
              activeTab === 'details' ? 'border-[var(--accent)] text-[var(--accent)]' : 'border-transparent text-[var(--text-secondary)] hover:text-[var(--text-primary)]'
            }`}
          ...
          {id !== 'add' && (
            <button
              className={`px-4 py-3 text-xs font-semibold cursor-pointer border-b-2 transition-colors ${
                activeTab === 'policy' ? 'border-[var(--accent)] text-[var(--accent)]' : 'border-transparent text-[var(--text-secondary)] hover:text-[var(--text-primary)]'
              }`}
            ...
            <form onSubmit={handleSave} className="space-y-8">
              <div className="grid grid-cols-2 gap-8">
                ...
                <div className="space-y-5">
                  <div>
                    <label className="block font-medium text-[var(--text-primary)] mb-1.5 text-xs">Parent Organization <span className="text-rose-500">*</span></label>
                    {id === 'add' && !parentOrgPublicId ? (
                      ...
                      <input
                        ...
                        className="register-input w-full text-sm bg-[var(--surface-sunken)] text-[var(--text-secondary)] cursor-not-allowed"
                        readOnly
                        disabled
                      />
                    )}
                  ...
                  <div>
                    <label className="block font-medium text-[var(--text-primary)] mb-1.5 text-xs">Branch Name <span className="text-rose-500">*</span></label>
                  ...
                  <div>
                    <label className="block font-medium text-[var(--text-primary)] mb-1.5 text-xs">Full Address</label>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <label className="block font-medium text-[var(--text-primary)] mb-1.5 text-xs">City</label>
                    ...
                    <div>
                      <label className="block font-medium text-[var(--text-primary)] mb-1.5 text-xs">State</label>
                    ...
                    <div>
                      <label className="block font-medium text-[var(--text-primary)] mb-1.5 text-xs">Pincode</label>
                      <input type="text" value={branchForm.pincode} onChange={(e) => setBranchForm({ ...branchForm, pincode: e.target.value })} className="register-input w-full  text-sm" />
                    </div>
                  </div>

                  <div>
                    <label className="block font-medium text-[var(--text-primary)] mb-1.5 text-xs">WhatsApp Group ID</label>
                    <input type="text" value={branchForm.whatsAppGroupId} onChange={(e) => setBranchForm({ ...branchForm, whatsAppGroupId: e.target.value })} className="register-input w-full  text-sm" placeholder="Optional" />
                  </div>
                  ...
                  <div className="pt-2">
                    <label className="flex items-center gap-2 cursor-pointer">
                      ...
                      <span className="font-medium text-[var(--text-primary)] text-sm">Branch is Active</span>
                    </label>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="bg-[var(--surface-sunken)] p-4 rounded-md border border-[var(--rule)]">
                     <h4 className="font-semibold text-sm font-normal text-[var(--text-primary)] mb-3 flex items-center gap-2">
                       <Clock size={14} className="text-[var(--accent)]" />
                       IP Restrictions (Web Clock-in)
                     </h4>
                     <label className="block font-medium text-[var(--text-primary)] mb-1.5 text-xs">Allowed Office IPs</label>
                     <input
                       type="text"
                       ...
                       className="register-input w-full  text-sm"
                     />
                     <span className="text-xs font-normal text-[var(--text-secondary)] block mt-1">Comma-separated list of IP addresses allowed. Leave blank for no restriction.</span>
                  </div>

                  <div className="bg-[var(--surface-sunken)] p-4 rounded-md border border-[var(--rule)] space-y-3">
                     <div className="flex items-center justify-between">
                       <h4 className="font-semibold text-xs uppercase tracking-wider text-[var(--text-primary)] flex items-center gap-1.5">
                         <MapIcon size={13} className="text-[var(--accent)]" />
                         Geofencing
                       </h4>
                       <button
                         type="button"
                         ...
                         className="px-2.5 py-1 text-xs font-semibold rounded bg-[var(--surface)] border border-[var(--rule)] hover:border-[var(--accent)] text-[var(--text-primary)] flex items-center gap-1.5 transition-colors cursor-pointer"
                       >
                         {locatingUser ? <Loader2 size={12} className="animate-spin text-[var(--accent)]" /> : <Navigation size={12} className="text-[var(--accent)]" />}
                     ...
                     <div className="relative">
                       <label className="block text-xs font-semibold text-[var(--text-primary)] mb-1">Search Location</label>
                       <div className="relative">
                         ...
                         />
                         {searchingPlace && (
                           <Loader2 size={14} className="animate-spin absolute right-3 top-1/2 -translate-y-1/2 text-[var(--accent)]" />
                         )}
                       </div>
                         ...
                         <div className="absolute top-full left-0 right-0 z-50 mt-1 bg-[var(--surface)] border border-[var(--rule)] rounded-[4px] shadow-xl max-h-48 overflow-y-auto">
                           {placeResults.map((place: any, idx: number) => (
                             <button
                               ...
                               className="w-full text-left px-3 py-2 text-xs hover:bg-[var(--surface-sunken)] border-b border-[var(--rule)]/40 last:border-0 flex items-start gap-2 text-[var(--text-primary)] transition-colors cursor-pointer"
                             >
                               <MapPin size={13} className="text-[var(--accent)] shrink-0 mt-0.5" />
                     ...
                     <div className="grid grid-cols-3 gap-3">
                       <div>
                         <label className="block text-xs font-semibold text-[var(--text-primary)] mb-1">Latitude</label>
                         <input type="number" step="0.000001" value={branchForm.latitude} onChange={(e) => setBranchForm({ ...branchForm, latitude: parseFloat(e.target.value) })} onKeyDown={(e) => { if (e.key === 'Enter') e.preventDefault(); }} className="register-input w-full  text-xs" />
                       </div>
                       <div>
                         <label className="block text-xs font-semibold text-[var(--text-primary)] mb-1">Longitude</label>
                         <input type="number" step="0.000001" value={branchForm.longitude} onChange={(e) => setBranchForm({ ...branchForm, longitude: parseFloat(e.target.value) })} onKeyDown={(e) => { if (e.key === 'Enter') e.preventDefault(); }} className="register-input w-full  text-xs" />
                       </div>
                       <div>
                         <label className="block text-xs font-semibold text-[var(--text-primary)] mb-1">Radius (m)</label>
                         <input type="number" value={branchForm.radiusMeters} onChange={(e) => setBranchForm({ ...branchForm, radiusMeters: parseInt(e.target.value) })} onKeyDown={(e) => { if (e.key === 'Enter') e.preventDefault(); }} className="register-input w-full  text-xs" />
                       </div>
                     </div>
                     ...
                     <div className="w-full h-[250px] bg-slate-100 rounded border border-[var(--rule)] overflow-hidden relative">
                        ...
                        <div className="absolute top-2 right-2 z-[1000] bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm p-1 rounded-md shadow-md border border-[var(--rule)] flex items-center gap-1">
                          <button
                            ...
                            className={`px-2 py-0.5 text-xs font-normal font-semibold uppercase tracking-wider rounded transition-colors ${
                              mapMode === 'streets'
                          ...
                          <button
                            ...
                            className={`px-2 py-0.5 text-xs font-normal font-semibold uppercase tracking-wider rounded transition-colors flex items-center gap-1 ${
                              mapMode === 'satellite'
                                ? 'bg-[var(--accent)] text-white shadow-sm'
                                : 'text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-sunken)]'
                            }`}
                        ...
                        {(branchForm.latitude && branchForm.longitude) ? (
                          ...
                          <div className="absolute inset-0 flex items-center justify-center text-[var(--text-secondary)] flex-col gap-2">
                            <MapPin size={24} className="opacity-20" />
                            <p className="text-xs font-normal">No valid GPS coordinates</p>
                          </div>
                        )}
                     </div>
                  </div>
            ...
            <form onSubmit={handleSavePolicy} className="space-y-6 max-w-3xl">
              ...
              <div className="bg-[var(--surface-sunken)] p-5 rounded-lg border border-[var(--rule)] space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-semibold text-[var(--text-primary)] text-sm">Working Hours & Late-In Rules</h4>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 pt-1">
                  <div>
                    <label className="block text-sm font-semibold text-[var(--text-primary)] mb-1">Grace Period for Late In (Minutes)</label>
                    <input
                      type="number"
                      ...
                      max={120}
                    />
                    <p className="text-xs font-normal text-[var(--text-secondary)] mt-1">Punches within this buffer are marked On-Time.</p>
                  </div>

                  <div>
                    <label className="block text-sm font-semibold text-[var(--text-primary)] mb-1">Half-Day Threshold (Hours)</label>
                    <input
                      type="number"
                      step="0.5"
                      ...
                      max={12}
                    />
                    <p className="text-xs font-normal text-[var(--text-secondary)] mt-1">Work duration below this triggers Half-Day deduction.</p>
                  </div>

                  <div>
                    <label className="block text-sm font-semibold text-[var(--text-primary)] mb-1">Full-Day Working Hours Requirement</label>
                    <input
                      type="number"
                      step="0.5"
                      ...
                      max={16}
                    />
                    <p className="text-xs font-normal text-[var(--text-secondary)] mt-1">Minimum productive hours for full Present credit.</p>
                  </div>

                  <div>
                    <label className="block text-sm font-semibold text-[var(--text-primary)] mb-1">Biometric Device Auto-Sync Frequency</label>
                    <select
                    ...
                    <p className="text-xs font-normal text-[var(--text-secondary)] mt-1">Cloud sync frequency from biometric hardware.</p>
                  </div>
                </div>
              </div>
